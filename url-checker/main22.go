...
func main2() {
	...
	people := [5]string{"ella", "moon", "sun", "star", "earth"}
	...
	// fmt.Println("Received", resultThree) // 3개를 받으려고 하면 메시지를 대기하고 있으나 goroutines은 이미 끝났으므로(2개출력) deadlock이 발생한다. 채널 메시지 수신은 blocking operation이다.
